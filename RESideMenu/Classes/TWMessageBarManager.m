...
+ (void)showInfoMessage:(NSString *)title description:(NSString *)desc
{
    [[TWMessageBarManager sharedInstance] showMessageWithTitle:title description:desc type:TWMessageBarMessageTypeInfo];
}
